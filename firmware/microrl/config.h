...
#define _COMMAND_LINE_LEN (1+256)									// for 32 chars
...
If it's set to zero, the whole line will be in the first token.*/
#define _COMMAND_TOKEN_NMB 0
...
#define _PROMPT_DEFAULT "\033[1;32mzForth>\033[0m "	// green color
